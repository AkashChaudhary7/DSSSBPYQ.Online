...
export const PartAMockSpecialBanner: React.FC<PartAMockSpecialBannerProps> = ({
  ...
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.98 }}
      onClick={onClick}
      className={`hidden sm:block relative overflow-hidden rounded-2xl md:rounded-3xl bg-gradient-to-br from-blue-700 via-indigo-800 to-slate-900 border border-blue-500/40 shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer p-4 sm:p-6 ${className}`}
    >
