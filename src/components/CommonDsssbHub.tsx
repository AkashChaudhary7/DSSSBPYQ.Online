...
import { 
  Building2, BookOpen, Trophy, Share2, Lock, Clock, CheckCircle2, Sparkles, Play 
} from 'lucide-react';
        ...
        <div className="space-y-1.5">
          <div className="flex items-center gap-2.5 flex-wrap">
            <span className="bg-amber-100 text-amber-900 border border-amber-200 text-[10px] font-extrabold px-3 py-0.5 rounded-full uppercase tracking-wider flex items-center gap-1 shadow-2xs">
              ...
              <span className="hidden sm:inline">Common for All DSSSB Posts</span>
                  ...
                  className={`bg-white dark:bg-slate-900 border-2 rounded-2xl p-4 md:p-5 flex flex-col justify-between gap-4 transition-all group relative ${
                    isAttempted 
                      ...
                      : isLocked 
                        ...
                        : 'border-slate-200/90 dark:border-slate-800 hover:border-amber-500 hover:shadow-md'
                  }`}
                >
                  <div className="space-y-2">
                    <div className="flex items-center gap-1.5 flex-nowrap overflow-x-auto scrollbar-none pb-0.5">
                      ...
                      <span className="bg-amber-100 dark:bg-amber-950/60 text-amber-900 dark:text-amber-300 border border-amber-200 dark:border-amber-800 text-[10px] font-bold px-2 py-0.5 rounded-md shrink-0 whitespace-nowrap">
                        📌 {topicBadge}
                      </span>
                    ...
                    <h3 className="font-black text-sm text-slate-900 dark:text-slate-100 leading-snug group-hover:text-amber-700 dark:group-hover:text-amber-400 transition-colors text-center py-2 border-y border-slate-100/80 dark:border-slate-800 my-1">
                      {quiz.title}
                    </h3>
                  </div>
                  ...
                  <div className="pt-3 border-t border-slate-100 dark:border-slate-800 flex items-center gap-2 w-full shrink-0">
                    <button
                      ...
                      className="px-3 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 flex items-center gap-1 shrink-0"
                    ...
                    {canStart ? (
                      <button
                        ...
                        className="flex-1 py-2 rounded-xl text-xs font-extrabold transition-all cursor-pointer bg-amber-600 hover:bg-amber-700 text-white shadow-xs text-center flex items-center justify-center gap-1.5"
                      >
                      ...
                      <button
                        ...
                        className="flex-1 py-2 rounded-xl text-xs font-extrabold transition-all cursor-pointer bg-slate-800 hover:bg-slate-900 text-white shadow-xs text-center flex items-center justify-center gap-1.5"
                      >
